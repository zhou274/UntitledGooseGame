            ...
            else
            {
                ...
                if (newPoolBuilder.name.Equals(EMPTY_POOL_BUILDER_NAME))
                {
                    ...
                    if (isSettingsExpanded)
                    {
                        ...
                        serializedObject.FindProperty("objectsContainer").objectReferenceValue = (Transform)EditorGUILayout.ObjectField("Objects container: ", serializedObject.FindProperty("objectsContainer").objectReferenceValue, typeof(Transform), true);
                        //GameObject prefab = (GameObject)EditorGUILayout.ObjectField("Prefab: ", currentPrefab, typeof(GameObject), true);
