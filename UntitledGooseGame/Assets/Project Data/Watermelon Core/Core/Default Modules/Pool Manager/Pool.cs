...
namespace Watermelon
{
    ...
    public class Pool
    {
        ...
        protected void SetupPooledObject(GameObject gameObject, PooledObjectSettings settings)
        {
            ...
            if (settings.ApplyLocalEulerRotatition)
            {
                objectTransform.localEulerAngles = settings.LocalEulerRotation;
            }

            if (settings.ApplyLocalRotatition)
            {
                objectTransform.localRotation = settings.LocalRotation;
            }
        ...
        {
            GameObject newObject = PoolManager.SpawnObject(singlePoolPrefab, objectsContainer != null ? objectsContainer : null);
        ...
        {
            GameObject newObject = PoolManager.SpawnObject(multiPoolPrefabsList[PoolIndex].prefab, objectsContainer != null ? objectsContainer : null);
