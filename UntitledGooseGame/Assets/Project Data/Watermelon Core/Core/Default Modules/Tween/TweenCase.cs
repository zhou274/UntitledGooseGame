...
namespace Watermelon
{
    ...
    public class TweenCaseRectTransformAnchoredPositionX : TweenCaseFunction<RectTransform, float>
    {
        public TweenCaseRectTransformAnchoredPositionX(RectTransform tweenObject, float resultValue) : base(tweenObject, resultValue)
        {
            parentObject = tweenObject.gameObject;

            startValue = tweenObject.anchoredPosition.x;
        }
        ...
        public override void DefaultComplete()
        {
            tweenObject.anchoredPosition = tweenObject.anchoredPosition.SetX(resultValue);
        }

        public override void Invoke(float deltaTime)
        {
            tweenObject.anchoredPosition = tweenObject.anchoredPosition.SetX(Mathf.LerpUnclamped(startValue, resultValue, Interpolate(state)));
        }
    }

    public class TweenCaseRectTransformAnchoredPositionY : TweenCaseFunction<RectTransform, float>
    {
        public TweenCaseRectTransformAnchoredPositionY(RectTransform tweenObject, float resultValue) : base(tweenObject, resultValue)
        {
            parentObject = tweenObject.gameObject;

            startValue = tweenObject.anchoredPosition.y;
        }
        ...
        public override void DefaultComplete()
        {
            tweenObject.anchoredPosition = tweenObject.anchoredPosition.SetY(resultValue);
        }

        public override void Invoke(float deltaTime)
        {
            tweenObject.anchoredPosition = tweenObject.anchoredPosition.SetY(Mathf.LerpUnclamped(startValue, resultValue, Interpolate(state)));
        }
    }
