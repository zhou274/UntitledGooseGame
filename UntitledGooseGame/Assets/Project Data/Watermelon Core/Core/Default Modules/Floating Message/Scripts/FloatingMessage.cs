    ...
    public class FloatingMessage : MonoBehaviour
    {
        ...
        public static void ShowMessage(string message, float timeMultiplier = 1.0f)
        {
            if(floatingMessage != null)
            {
                ...
                floatingMessage.animationTweenCase = floatingMessage.windowRectTransform.DOScale(1.1f, 0.2f * timeMultiplier, unscaledTime: true).SetEasing(Ease.Type.CircOut).OnComplete(delegate
                {
                    floatingMessage.animationTweenCase = floatingMessage.windowRectTransform.DOScale(1f, 0.05f * timeMultiplier, unscaledTime: true).OnComplete(delegate
                    {
                        floatingMessage.animationTweenCase = Tween.DelayedCall(0.4f * timeMultiplier, delegate
                        {
