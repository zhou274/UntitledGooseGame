...
namespace Watermelon
{
    ...
    public class SetupGuideInfoEditor : WatermelonEditor
    {
        ...
        private const string OPEN_ON_PROJECT_LOAD_PROPERTY_PATH = "openOnProjectLoad";
        ...
        private const string CHANGELOG_PATH_SUFFIX = "/Changelog.txt";
        ...
        private SerializedProperty startupProperty;
        ...
        protected override void OnEnable()
        {
            ...
            startupProperty = targetSerializedObject.FindProperty(OPEN_ON_PROJECT_LOAD_PROPERTY_PATH);
        ...
        public override void OnInspectorGUI()
        {
            ...
            startupProperty.boolValue = EditorGUILayout.ToggleLeft("open on project load", startupProperty.boolValue);
