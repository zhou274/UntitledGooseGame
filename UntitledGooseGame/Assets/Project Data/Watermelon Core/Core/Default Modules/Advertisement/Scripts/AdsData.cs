...
namespace Watermelon
{
    ...
    public class AdsData : ScriptableObject
    {
        ...
        [SerializeField] UnityAdsContainer unityAdsContainer;
        public UnityAdsContainer UnityAdsSettings => unityAdsContainer;

        [SerializeField] IronSourceContainer ironSourceContainer;
        public IronSourceContainer IronSourceSettings => ironSourceContainer;
