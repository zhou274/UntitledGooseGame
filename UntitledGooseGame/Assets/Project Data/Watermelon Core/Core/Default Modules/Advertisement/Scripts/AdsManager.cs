...
namespace Watermelon
{
    ...
    public static class AdsManager
    {
        ...
        private static AdvertisingHandler[] advertisingModules = new AdvertisingHandler[]
        {
            ...
            new IronSourceHandler(AdvertisingModules.IronSource), // Iron Source module
#endif
        };
...
#if MODULE_GA
                GameAnalyticsSDK.GameAnalytics.NewAdEvent(GameAnalyticsSDK.GAAdAction.FailedShow, GameAnalyticsSDK.GAAdType.Interstitial, advertisingModules.ToString(), advertisingActiveModules[advertisingModules].GetInterstitialID());
#endif
        ...
        public static void ShowRewardBasedVideo(AdvertisingModules advertisingModules, AdvertisingHandler.RewardedVideoCallback callback, bool showErrorMessage = true)
        {
            ...
            {
#if MODULE_GA
                GameAnalyticsSDK.GameAnalytics.NewAdEvent(GameAnalyticsSDK.GAAdAction.FailedShow, GameAnalyticsSDK.GAAdType.RewardedVideo, advertisingModules.ToString(), advertisingActiveModules[advertisingModules].GetRewardedVideoID());
#endif
