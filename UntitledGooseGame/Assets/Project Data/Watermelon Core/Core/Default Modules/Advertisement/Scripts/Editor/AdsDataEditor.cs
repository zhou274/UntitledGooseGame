...
namespace Watermelon
{
    ...
    public class AdsDataEditor : WatermelonEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            testModeProperty.boolValue = UnityEditor.Advertisements.AdvertisementSettings.testMode;
            SerializedProperty unityAdsContainerProperty = serializedObject.FindProperty("unityAdsContainer");
        ...
        {
            SerializedProperty androidBannerIDProperty;
            SerializedProperty iOSBannerIDProperty;
            SerializedProperty androidInterstitialIDProperty;
            SerializedProperty iOSInterstitialIDProperty;
            SerializedProperty androidRewardedVideoIDProperty;
            SerializedProperty iOSRewardedVideoIDProperty;
            SerializedProperty bannerPositionProperty;
            ...
            protected override void SpecialButtons()
            {
                ...
                EditorGUILayout.HelpBox("Tested with Advertisement v4.3.0", MessageType.Info);
            }
        }
