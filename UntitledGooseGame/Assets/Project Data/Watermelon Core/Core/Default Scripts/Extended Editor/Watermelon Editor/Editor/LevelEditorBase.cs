...
namespace Watermelon
{
    public abstract class LevelEditorBase : WatermelonWindow
    {
        ...
        protected virtual string LEVELS_DATABASE_FOLDER_PATH { get => "Assets/" + ApplicationConsts.PROJECT_FOLDER + "/Content/LevelSystem"; }
        ...
        public bool WindowClosedInPlaymode()
        {
