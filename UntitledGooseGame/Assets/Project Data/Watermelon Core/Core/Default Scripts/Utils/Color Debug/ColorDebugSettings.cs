...
namespace Watermelon {
    ...
    public partial class ColorDebugSettings : ScriptableObject, IInitialized
    {
        ...
        public void Init()
        {
            ...
            Log(new ColoredText("#FFFEB7", "ColorDebug => ").MakeBold().Append("Inited"));
        }  
